...
# -*- coding: utf-8 -*-
#
# temporal-caching documentation build configuration file, created by
...
# built documents.
#
_version_py = os.path.join('..', 'temporalcache', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'temporal-cachingdoc'
...
latex_documents = [
    (master_doc, 'temporal-caching.tex', 'temporal-caching Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'temporal-caching', 'temporal-caching Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'temporal-caching', 'temporal-caching Documentation',
     author, 'temporal-caching', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    tc_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'temporalcache'))
